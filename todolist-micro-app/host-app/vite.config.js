...
export default defineConfig({
  ...
  plugins: [
    ...
    federation({
      ...
      remotes: { // 設定遠端模組的映射關係。
        todo_components: "http://localhost:4173/remoteEntry.js", // 遠端應用程式的入口檔案位置，通常是通過 @originjs/vite-plugin-federation 自動生成。
      },
  ...
  server: {
    port: 5173, // 開發環境的端口，避免與其他專案衝突。透過 npm run dev 啟動
  },
  preview: {
